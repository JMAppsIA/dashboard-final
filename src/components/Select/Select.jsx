...
const Select = ({hasLabel, label, data, value, name, onChange, error, defaultOptionLabel, searchPlaceholder }) => {
    ...
    <div className="form__group">
      ...
      <div className="dropdown" ref={dropdownEl}>
        ...
        <div className="dropdown__selected" onClick={() => setShowDropdown(!showDropdown)}>
          { selectedValue ? selectedValue : defaultOptionLabel ? defaultOptionLabel : 'Please select...' }
        </div>
        {showDropdown && 
          <Dropdown 
